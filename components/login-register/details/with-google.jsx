...
export default function WithGoogle({ anyClass }) {
  return (
    <a
      href="#"
      className={`w-[135px] sm:w-[54px] h-[54px] gap-2 rounded-full bg-white flex items-center justify-center ${anyClass}`}
    >
      <svg
        width="24"
        height="24"
      ...
      <span className="sm:hidden inline">Google</span>
    </a>
  );
}
