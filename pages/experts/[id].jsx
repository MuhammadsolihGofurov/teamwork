...
import { ExpertDetail, TaskDetail } from "@/components/detail-pages";
import axios from "@/utils/axios";
import { ExpertsUrl, FaqsUrl, ProfileUrl, TasksUrl } from "@/utils/router";
  ...
  return (
    <>
      <Seo
        ...
        description={data?.necessary_information}
        keywords={data?.full_name}
      />
      {loading ? (
        <TaskDetailsSkeleton />
      ) : (
