...
import ExperienceResumeForm from "@/components/profile/details/resume/experience-resume-form";
      ...
      >
        {!isMobile ? (
          <>
            {/* Desktop view */}
            <LeftInfoProfile />
            <CenterInfoProfile page={"resume-experience"} tabsMenu={ResumeMenu} />
            <RightInfoAll />
          </>
        ) : (
          <>
            {/* Mobile view */}
            <ExperienceResumeForm isMobile={isMobile} />
          </>
        )}
      </ProfileWrapper>
...
export async function getServerSideProps({ params, locale }) {
  const info = {
    seo_home_title: "Profile resume experience for expert ",
    seo_home_keywords: "",
